...
<div className='w-48 h-auto flex items-center justify-center relative md:w-30'>
    <CircularText className={"fill-dark animate-spin-slow dark:fill-light"} />

<Link href="mailto:pothanavenkatamouli322@gmail.com" className='flex items-center justify-center
